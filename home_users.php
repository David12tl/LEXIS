    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            ...
            <div class="text-center" style="margin-top: 20px;">
                <h2 class="all-tittles">Bienvenido al sistema bibliotecario</h2>
                <p>Este sistema tiene como objetivo facilitar la gestión de libros y recursos bibliográficos.</p>
            </div>
        </div>
        <section>
