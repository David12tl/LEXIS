        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="autor_rec.php"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i>&nbsp;&nbsp; Autor</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema bibliotecario <small>AUTORES</small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nuevos Autores de libros, debes de llenar todos los campos del siguiente formulario para registrar un Autor
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      ...
                      <li><a href="components/lista_autores_rec.php">Lista de Autores</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Registrar un nuevo Autor</div>
                <form class="form-padding" action="../autor/agregar_autor.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <input name="biografia" type="text" class="material-control tooltips-general" placeholder="biografia"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Email del administrador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12">
                           <div class="group-material">
                                <input name="Libro" type="text" class="material-control tooltips-general input-check-user" placeholder="Libros escritos" title="Escribe un nombre de usuario sin espacios, que servira para iniciar sesión">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Libro</label>
                           </div>
                        ...
                        <div class="col-xs-12 col-sm-6">
                           <div class="group-material">
                                <input name="fecha_nacimiento" type="date" class="material-control tooltips-general" placeholder="Repite la contraseña" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Repite la contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
