...
<?php
    ...
    include("../../acciones/acciones_autor.php");
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="../../libros/administrador/libros_disponibles.php"><i class="zmdi zmdi-calendar zmdi-hc-fw"></i>&nbsp;&nbsp; Todos los préstamos</a></li>
                            <li>
                                <a href="../../libros/administrador/libros_ocupados.php"><i class="zmdi zmdi-time-restore zmdi-hc-fw"></i>&nbsp;&nbsp; Devoluciones pendientes <span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                            <li>
                                <a href="../../libros/admnistrador/libros_reservados.php"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>&nbsp;&nbsp; Reservaciones <span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <p>Bienvenido a la sección Lista de Autores de libros, en este apartado podrás visualizar la información guardada de todos los Autores.</p>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="autor_añadir.php">AGREGAR</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="full-reset text-center" style="padding: 40px 0;">
                    ...
                    <table class="table table-hover" id="table_empleados">
                        ...
                        <t>
                            ...
                            foreach ($empleados as $empleado) { ?>
                                <tr id="empleado_<?php echo $empleado['id_autor']; ?>">
                                    <th scope='row'><?php echo $empleado['id_autor']; ?></th>
                                    <td><?php echo $empleado['nombre']; ?></td>
                                    <td> <?php echo $empleado['biografia']; ?></td>
                                    <td><?php echo $empleado['Libro']; ?></td>
